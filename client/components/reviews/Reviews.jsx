...
// Check metadata to get full number of reviews.
// Do the get requests once at the beginning and get all the reviews.
...
function Reviews() {
  ...
  const getNumberOfReviews = async () => {
    ...
    let result = Object.values(data.data.ratings);
    result = Object.values(data.data.ratings).map((item) => Number(item));
